...
models on other datasets including Chinese, please refer to [PP-OCRv3 models list](../ppocr/model_list.en.md).

>
Developers are welcome to contribute more algorithms! Please refer to [add new algorithm](./add_new_algorithm.en.md)
guideline.
