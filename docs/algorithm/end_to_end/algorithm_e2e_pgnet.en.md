...
Please refer to [Operation Environment Preparation](../../ppocr/environment.en.md) to configure PaddleOCR operating
environment first, refer to [Project Clone](../../ppocr/blog/clone.en.md) to clone the project
...
If you would like to load trained model and continue the training again, you can specify the parameter
`Global.checkpoints` as the model path to be loaded.
